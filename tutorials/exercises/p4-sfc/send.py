...
def main():
    ...
    parser.add_argument('-dscp', type=int, help="The DSCP field in the IP header")
    parser.add_argument('-i', '--interval', type=float, default=1.0, help="Interval between packets in seconds")  # New argument for interval
